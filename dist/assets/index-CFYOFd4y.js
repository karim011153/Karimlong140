(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(o){if(o.ep)return;o.ep=!0;const a=s(o);fetch(o.href,a)}})();const Qe="modulepreload",Ze=function(t){return"/"+t},Se={},Xe=function(e,s,n){let o=Promise.resolve();if(s&&s.length>0){let i=function(h){return Promise.all(h.map(d=>Promise.resolve(d).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),l=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));o=i(s.map(h=>{if(h=Ze(h),h in Se)return;Se[h]=!0;const d=h.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${u}`))return;const p=document.createElement("link");if(p.rel=d?"stylesheet":Qe,d||(p.as="script"),p.crossOrigin="",p.href=h,l&&p.setAttribute("nonce",l),document.head.appendChild(p),d)return new Promise((g,b)=>{p.addEventListener("load",g),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${h}`)))})}))}function a(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return o.then(i=>{for(const r of i||[])r.status==="rejected"&&a(r.reason);return e().catch(a)})};/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:nt,defineProperty:ot,getOwnPropertyDescriptor:at,getOwnPropertyNames:it,getOwnPropertySymbols:rt,getPrototypeOf:lt}=Object,H=globalThis,Ce=H.trustedTypes,ht=Ce?Ce.emptyScript:"",fe=H.reactiveElementPolyfillSupport,Q=(t,e)=>t,he={toAttribute(t,e){switch(e){case Boolean:t=t?ht:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=t!==null;break;case Number:s=t===null?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch{s=null}}return s}},xe=(t,e)=>!nt(t,e),Be={attribute:!0,type:String,converter:he,reflect:!1,useDefault:!1,hasChanged:xe};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),H.litPropertyMetadata??(H.litPropertyMetadata=new WeakMap);let Y=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,s=Be){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(e,s),!s.noAccessor){const n=Symbol(),o=this.getPropertyDescriptor(e,n,s);o!==void 0&&ot(this.prototype,e,o)}}static getPropertyDescriptor(e,s,n){const{get:o,set:a}=at(this.prototype,e)??{get(){return this[s]},set(i){this[s]=i}};return{get:o,set(i){const r=o==null?void 0:o.call(this);a==null||a.call(this,i),this.requestUpdate(e,r,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Be}static _$Ei(){if(this.hasOwnProperty(Q("elementProperties")))return;const e=lt(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Q("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Q("properties"))){const s=this.properties,n=[...it(s),...rt(s)];for(const o of n)this.createProperty(o,s[o])}const e=this[Symbol.metadata];if(e!==null){const s=litPropertyMetadata.get(e);if(s!==void 0)for(const[n,o]of s)this.elementProperties.set(n,o)}this._$Eh=new Map;for(const[s,n]of this.elementProperties){const o=this._$Eu(s,n);o!==void 0&&this._$Eh.set(o,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const s=[];if(Array.isArray(e)){const n=new Set(e.flat(1/0).reverse());for(const o of n)s.unshift(Le(o))}else e!==void 0&&s.push(Le(e));return s}static _$Eu(e,s){const n=s.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(s=>s(this))}addController(e){var s;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((s=e.hostConnected)==null||s.call(e))}removeController(e){var s;(s=this._$EO)==null||s.delete(e)}_$E_(){const e=new Map,s=this.constructor.elementProperties;for(const n of s.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return st(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(s=>{var n;return(n=s.hostConnected)==null?void 0:n.call(s)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(s=>{var n;return(n=s.hostDisconnected)==null?void 0:n.call(s)})}attributeChangedCallback(e,s,n){this._$AK(e,n)}_$ET(e,s){var a;const n=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,n);if(o!==void 0&&n.reflect===!0){const i=(((a=n.converter)==null?void 0:a.toAttribute)!==void 0?n.converter:he).toAttribute(s,n.type);this._$Em=e,i==null?this.removeAttribute(o):this.setAttribute(o,i),this._$Em=null}}_$AK(e,s){var a,i;const n=this.constructor,o=n._$Eh.get(e);if(o!==void 0&&this._$Em!==o){const r=n.getPropertyOptions(o),l=typeof r.converter=="function"?{fromAttribute:r.converter}:((a=r.converter)==null?void 0:a.fromAttribute)!==void 0?r.converter:he;this._$Em=o;const h=l.fromAttribute(s,r.type);this[o]=h??((i=this._$Ej)==null?void 0:i.get(o))??h,this._$Em=null}}requestUpdate(e,s,n,o=!1,a){var i;if(e!==void 0){const r=this.constructor;if(o===!1&&(a=this[e]),n??(n=r.getPropertyOptions(e)),!((n.hasChanged??xe)(a,s)||n.useDefault&&n.reflect&&a===((i=this._$Ej)==null?void 0:i.get(e))&&!this.hasAttribute(r._$Eu(e,n))))return;this.C(e,s,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,s,{useDefault:n,reflect:o,wrapped:a},i){n&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,i??s??this[e]),a!==!0||i!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(s=void 0),this._$AL.set(e,s)),o===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var n;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[a,i]of this._$Ep)this[a]=i;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[a,i]of o){const{wrapped:r}=i,l=this[a];r!==!0||this._$AL.has(a)||l===void 0||this.C(a,void 0,i,l)}}let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),(n=this._$EO)==null||n.forEach(o=>{var a;return(a=o.hostUpdate)==null?void 0:a.call(o)}),this.update(s)):this._$EM()}catch(o){throw e=!1,this._$EM(),o}e&&this._$AE(s)}willUpdate(e){}_$AE(e){var s;(s=this._$EO)==null||s.forEach(n=>{var o;return(o=n.hostUpdated)==null?void 0:o.call(n)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(s=>this._$ET(s,this[s]))),this._$EM()}updated(e){}firstUpdated(e){}};Y.elementStyles=[],Y.shadowRootOptions={mode:"open"},Y[Q("elementProperties")]=new Map,Y[Q("finalized")]=new Map,fe==null||fe({ReactiveElement:Y}),(H.reactiveElementVersions??(H.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Z=globalThis,_e=t=>t,de=Z.trustedTypes,je=de?de.createPolicy("lit-html",{createHTML:t=>t}):void 0,Re="$lit$",O=`lit$${Math.random().toFixed(9).slice(2)}$`,De="?"+O,dt=`<${De}>`,N=document,X=()=>N.createComment(""),ee=t=>t===null||typeof t!="object"&&typeof t!="function",Te=Array.isArray,ct=t=>Te(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",we=`[ 	
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Pe=/-->/g,Oe=/>/g,R=RegExp(`>|${we}(?:([^\\s"'>=/]+)(${we}*=${we}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),He=/'/g,We=/"/g,qe=/^(?:script|style|textarea|title)$/i,Ne=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),c=Ne(1),$=Ne(2),F=Symbol.for("lit-noChange"),k=Symbol.for("lit-nothing"),Ee=new WeakMap,D=N.createTreeWalker(N,129);function Fe(t,e){if(!Te(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return je!==void 0?je.createHTML(e):e}const ut=(t,e)=>{const s=t.length-1,n=[];let o,a=e===2?"<svg>":e===3?"<math>":"",i=K;for(let r=0;r<s;r++){const l=t[r];let h,d,u=-1,p=0;for(;p<l.length&&(i.lastIndex=p,d=i.exec(l),d!==null);)p=i.lastIndex,i===K?d[1]==="!--"?i=Pe:d[1]!==void 0?i=Oe:d[2]!==void 0?(qe.test(d[2])&&(o=RegExp("</"+d[2],"g")),i=R):d[3]!==void 0&&(i=R):i===R?d[0]===">"?(i=o??K,u=-1):d[1]===void 0?u=-2:(u=i.lastIndex-d[2].length,h=d[1],i=d[3]===void 0?R:d[3]==='"'?We:He):i===We||i===He?i=R:i===Pe||i===Oe?i=K:(i=R,o=void 0);const g=i===R&&t[r+1].startsWith("/>")?" ":"";a+=i===K?l+dt:u>=0?(n.push(h),l.slice(0,u)+Re+l.slice(u)+O+g):l+O+(u===-2?r:g)}return[Fe(t,a+(t[s]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]};class te{constructor({strings:e,_$litType$:s},n){let o;this.parts=[];let a=0,i=0;const r=e.length-1,l=this.parts,[h,d]=ut(e,s);if(this.el=te.createElement(h,n),D.currentNode=this.el.content,s===2||s===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(o=D.nextNode())!==null&&l.length<r;){if(o.nodeType===1){if(o.hasAttributes())for(const u of o.getAttributeNames())if(u.endsWith(Re)){const p=d[i++],g=o.getAttribute(u).split(O),b=/([.?@])?(.*)/.exec(p);l.push({type:1,index:a,name:b[2],strings:g,ctor:b[1]==="."?mt:b[1]==="?"?gt:b[1]==="@"?ft:ce}),o.removeAttribute(u)}else u.startsWith(O)&&(l.push({type:6,index:a}),o.removeAttribute(u));if(qe.test(o.tagName)){const u=o.textContent.split(O),p=u.length-1;if(p>0){o.textContent=de?de.emptyScript:"";for(let g=0;g<p;g++)o.append(u[g],X()),D.nextNode(),l.push({type:2,index:++a});o.append(u[p],X())}}}else if(o.nodeType===8)if(o.data===De)l.push({type:2,index:a});else{let u=-1;for(;(u=o.data.indexOf(O,u+1))!==-1;)l.push({type:7,index:a}),u+=O.length-1}a++}}static createElement(e,s){const n=N.createElement("template");return n.innerHTML=e,n}}function J(t,e,s=t,n){var i,r;if(e===F)return e;let o=n!==void 0?(i=s._$Co)==null?void 0:i[n]:s._$Cl;const a=ee(e)?void 0:e._$litDirective$;return(o==null?void 0:o.constructor)!==a&&((r=o==null?void 0:o._$AO)==null||r.call(o,!1),a===void 0?o=void 0:(o=new a(t),o._$AT(t,s,n)),n!==void 0?(s._$Co??(s._$Co=[]))[n]=o:s._$Cl=o),o!==void 0&&(e=J(t,o._$AS(t,e.values),o,n)),e}class pt{constructor(e,s){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:s},parts:n}=this._$AD,o=((e==null?void 0:e.creationScope)??N).importNode(s,!0);D.currentNode=o;let a=D.nextNode(),i=0,r=0,l=n[0];for(;l!==void 0;){if(i===l.index){let h;l.type===2?h=new oe(a,a.nextSibling,this,e):l.type===1?h=new l.ctor(a,l.name,l.strings,this,e):l.type===6&&(h=new wt(a,this,e)),this._$AV.push(h),l=n[++r]}i!==(l==null?void 0:l.index)&&(a=D.nextNode(),i++)}return D.currentNode=N,o}p(e){let s=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,s),s+=n.strings.length-2):n._$AI(e[s])),s++}}class oe{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,s,n,o){this.type=2,this._$AH=k,this._$AN=void 0,this._$AA=e,this._$AB=s,this._$AM=n,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=s.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,s=this){e=J(this,e,s),ee(e)?e===k||e==null||e===""?(this._$AH!==k&&this._$AR(),this._$AH=k):e!==this._$AH&&e!==F&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ct(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==k&&ee(this._$AH)?this._$AA.nextSibling.data=e:this.T(N.createTextNode(e)),this._$AH=e}$(e){var a;const{values:s,_$litType$:n}=e,o=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=te.createElement(Fe(n.h,n.h[0]),this.options)),n);if(((a=this._$AH)==null?void 0:a._$AD)===o)this._$AH.p(s);else{const i=new pt(o,this),r=i.u(this.options);i.p(s),this.T(r),this._$AH=i}}_$AC(e){let s=Ee.get(e.strings);return s===void 0&&Ee.set(e.strings,s=new te(e)),s}k(e){Te(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let n,o=0;for(const a of e)o===s.length?s.push(n=new oe(this.O(X()),this.O(X()),this,this.options)):n=s[o],n._$AI(a),o++;o<s.length&&(this._$AR(n&&n._$AB.nextSibling,o),s.length=o)}_$AR(e=this._$AA.nextSibling,s){var n;for((n=this._$AP)==null?void 0:n.call(this,!1,!0,s);e!==this._$AB;){const o=_e(e).nextSibling;_e(e).remove(),e=o}}setConnected(e){var s;this._$AM===void 0&&(this._$Cv=e,(s=this._$AP)==null||s.call(this,e))}}class ce{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,s,n,o,a){this.type=1,this._$AH=k,this._$AN=void 0,this.element=e,this.name=s,this._$AM=o,this.options=a,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=k}_$AI(e,s=this,n,o){const a=this.strings;let i=!1;if(a===void 0)e=J(this,e,s,0),i=!ee(e)||e!==this._$AH&&e!==F,i&&(this._$AH=e);else{const r=e;let l,h;for(e=a[0],l=0;l<a.length-1;l++)h=J(this,r[n+l],s,l),h===F&&(h=this._$AH[l]),i||(i=!ee(h)||h!==this._$AH[l]),h===k?e=k:e!==k&&(e+=(h??"")+a[l+1]),this._$AH[l]=h}i&&!o&&this.j(e)}j(e){e===k?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class mt extends ce{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===k?void 0:e}}class gt extends ce{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==k)}}class ft extends ce{constructor(e,s,n,o,a){super(e,s,n,o,a),this.type=5}_$AI(e,s=this){if((e=J(this,e,s,0)??k)===F)return;const n=this._$AH,o=e===k&&n!==k||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,a=e!==k&&(n===k||o);o&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var s;typeof this._$AH=="function"?this._$AH.call(((s=this.options)==null?void 0:s.host)??this.element,e):this._$AH.handleEvent(e)}}class wt{constructor(e,s,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=s,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){J(this,e)}}const ye=Z.litHtmlPolyfillSupport;ye==null||ye(te,oe),(Z.litHtmlVersions??(Z.litHtmlVersions=[])).push("3.3.3");const yt=(t,e,s)=>{const n=(s==null?void 0:s.renderBefore)??e;let o=n._$litPart$;if(o===void 0){const a=(s==null?void 0:s.renderBefore)??null;n._$litPart$=o=new oe(e.insertBefore(X(),a),a,void 0,s??{})}return o._$AI(t),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const q=globalThis;let _=class extends Y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var s;const e=super.createRenderRoot();return(s=this.renderOptions).renderBefore??(s.renderBefore=e.firstChild),e}update(e){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=yt(s,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return F}};var ze;_._$litElement$=!0,_.finalized=!0,(ze=q.litElementHydrateSupport)==null||ze.call(q,{LitElement:_});const be=q.litElementPolyfillSupport;be==null||be({LitElement:_});(q.litElementVersions??(q.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function C(t,e){return(s,n,o)=>{const a=i=>{var r;return((r=i.renderRoot)==null?void 0:r.querySelector(t))??null};return kt(s,n,{get(){return a(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * @license
 * SPDX-License-Identifier: Apache-2.0
 */const $t="EnglishLearningAppDB",Lt=1,W="lessonsAudio";let L;function Me(){return new Promise((t,e)=>{if(L)return t(L);const s=indexedDB.open($t,Lt);s.onerror=n=>{console.error("Database error:",n.target.error),e("Error opening database.")},s.onsuccess=n=>{L=n.target.result,t(L)},s.onupgradeneeded=n=>{const o=n.target.result;o.objectStoreNames.contains(W)||o.createObjectStore(W,{keyPath:"id"})}})}function G(t,e){return new Promise((s,n)=>{if(!L)return n("DB not initialized.");const o=L.transaction([W],"readwrite");o.objectStore(W).put({id:t,audioBlob:e}),o.oncomplete=()=>s(),o.onerror=i=>{console.error("Save audio transaction error:",i.target.error),n("Error saving audio file.")}})}function re(t){return new Promise((e,s)=>{if(!L)return s("DB not initialized.");const a=L.transaction([W],"readonly").objectStore(W).get(t);a.onsuccess=()=>{a.result?e(a.result.audioBlob):s("Audio not found for the given ID.")},a.onerror=i=>{console.error("Get audio request error:",i.target.error),s("Error fetching audio file.")}})}function Ct(t){return new Promise((e,s)=>{if(!L)return s("DB not initialized.");const n=L.transaction([W],"readwrite");n.objectStore(W).delete(t),n.oncomplete=()=>e(),n.onerror=a=>{console.error("Delete audio transaction error:",a.target.error),s("Error deleting audio file.")}})}/**
 * @license
 * SPDX-License-Identifier: Apache-2.0
*/function Ve(t){let e="";const s=t.byteLength;for(let n=0;n<s;n++)e+=String.fromCharCode(t[n]);return btoa(e)}function Ge(t){const e=atob(t),s=e.length,n=new Uint8Array(s);for(let o=0;o<s;o++)n[o]=e.charCodeAt(o);return n}function Bt(t){const e=t.length,s=new Int16Array(e);for(let n=0;n<e;n++)s[n]=t[n]*32768;return{data:Ve(new Uint8Array(s.buffer)),mimeType:"audio/pcm;rate=16000"}}async function _t(t,e,s,n){const o=e.createBuffer(n,t.length/2/n,s),a=new Int16Array(t.buffer),i=a.length,r=new Float32Array(i);for(let l=0;l<i;l++)r[l]=a[l]/32768;if(n===0)o.copyToChannel(r,0);else for(let l=0;l<n;l++){const h=r.filter((d,u)=>u%n===l);o.copyToChannel(h,l)}return o}function Ye(t,e,s=1){const n=new ArrayBuffer(44),o=new DataView(n),a=t.length,i=a+36;o.setUint32(0,1380533830,!1),o.setUint32(4,i,!0),o.setUint32(8,1463899717,!1),o.setUint32(12,1718449184,!1),o.setUint32(16,16,!0),o.setUint16(20,1,!0),o.setUint16(22,s,!0),o.setUint32(24,e,!0),o.setUint32(28,e*s*2,!0),o.setUint16(32,s*2,!0),o.setUint16(34,16,!0),o.setUint32(36,1684108385,!1),o.setUint32(40,a,!0);const r=new Uint8Array(n.byteLength+t.byteLength);return r.set(new Uint8Array(n),0),r.set(t,n.byteLength),r}function jt(t,e){const s=t.length*2,n=new ArrayBuffer(44+s),o=new DataView(n);o.setUint32(0,1380533830,!1),o.setUint32(4,36+s,!0),o.setUint32(8,1463899717,!1),o.setUint32(12,1718449184,!1),o.setUint32(16,16,!0),o.setUint16(20,1,!0),o.setUint16(22,1,!0),o.setUint32(24,e,!0),o.setUint32(28,e*2,!0),o.setUint16(32,2,!0),o.setUint16(34,16,!0),o.setUint32(36,1684108385,!1),o.setUint32(40,s,!0);const a=t.length;let i=44;for(let r=0;r<a;r++){let l=Math.max(-1,Math.min(1,t[r]));const h=l<0?l*32768:l*32767;o.setInt16(i,h,!0),i+=2}return new Blob([n],{type:"audio/wav"})}async function Je(t){const s=window.AudioContext||window.webkitAudioContext;if(!s)throw new Error("Web Audio API is not supported in this browser.");const n=[];for(let r=0;r<t.length;r++){const h=await t[r].arrayBuffer(),d=new s;let u;try{u=await d.decodeAudioData(h)}catch(T){throw console.error(`Error decoding audio blob #${r}:`,T),new Error(`تعذر فك تشفير الملف الصوتي للدرس #${r+1}. تأكد من سلامة وصلاحية ملف الصوت لهذا الدرس.`)}finally{await d.close()}const p=u.duration,g=Math.ceil(p*24e3),b=new OfflineAudioContext(1,g,24e3),x=b.createBufferSource();x.buffer=u,x.connect(b.destination),x.start();const v=(await b.startRendering()).getChannelData(0);n.push(v)}let o=0;for(const r of n)o+=r.length;const a=new Float32Array(o);let i=0;for(const r of n)a.set(r,i),i+=r.length;return jt(a,24e3)}function Ke(t,e=600){const s=t.split(`
`).map(o=>o.trim()).filter(o=>o.length>0),n=[];for(const o of s)if(o.length<=e)n.push(o);else{const a=o.split(new RegExp("(?<=[.!?])\\s+"));let i="";for(const r of a)(i+" "+r).trim().length<=e?i=(i+" "+r).trim():(i&&n.push(i),i=r);i.trim().length>0&&n.push(i.trim())}return n}async function Ie(t,e,s="Kore"){var r,l,h,d,u,p,g;const n=Ke(t),o=[],a=typeof window<"u"?localStorage.getItem("lingo_custom_api_key"):null,i=a&&a.trim()!==""&&a!=="undefined"&&a!=="null"?a.trim().replace(/^["']|["']$/g,""):null;for(const b of n){let x="",z=!1;try{const v={"Content-Type":"application/json"};i&&(v["x-gemini-api-key"]=i);const T=await fetch("/api/tts",{method:"POST",headers:v,body:JSON.stringify({text:b,voiceName:s})});if(T.ok)x=(await T.json()).base64Audio;else if(console.warn("Backend TTS API returned error, attempting direct Gemini API..."),i)z=!0;else{const B=await T.json().catch(()=>({}));throw new Error(B.error||"فشل الاتصال بخدمة توليد الصوت.")}}catch(v){if(console.warn("Backend TTS connection failed, attempting direct Gemini API:",v),i)z=!0;else throw new Error("فشل الاتصال بخدمة توليد الصوت. يرجى إدخال مفتاح API الخاص بك في الإعدادات المتقدمة.")}if(z&&i){const v=["gemini-3.1-flash-tts-preview"];let T=null,B=!1;for(const V of v)try{console.log(`[Direct Gemini TTS] Requesting model: ${V} with voice: ${s}`);const w=`https://generativelanguage.googleapis.com/v1beta/models/${V}:generateContent?key=${i}`,I=await fetch(w,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:b}]}],generationConfig:{response_modalities:["AUDIO"],speech_config:{voice_config:{prebuilt_voice_config:{voice_name:s||"Kore"}}}}})});if(!I.ok){const P=await I.json().catch(()=>({}));throw new Error(((r=P==null?void 0:P.error)==null?void 0:r.message)||`HTTP status ${I.status}`)}const U=(g=(p=(u=(d=(h=(l=(await I.json()).candidates)==null?void 0:l[0])==null?void 0:h.content)==null?void 0:d.parts)==null?void 0:u[0])==null?void 0:p.inlineData)==null?void 0:g.data;if(U){x=U,B=!0,console.log(`[Direct Gemini TTS] Success with model: ${V}`);break}}catch(w){console.warn(`[Direct Gemini TTS] Model ${V} failed to generate TTS:`,w),T=w}if(!B)throw T||new Error("فشلت جميع محاولات توليد الصوت مباشرة عبر Gemini. تأكد من صحة مفتاح الـ API الخاص بك.")}if(x){const v=Ge(x),T=Ye(v,24e3,1);o.push(new Blob([T],{type:"audio/wav"}))}else throw new Error("لم يتم إرجاع مقطع صوتي للجزء الحالي من النص.")}if(o.length===0)throw new Error("فشل توليد أي مقطع صوتي.");return o.length===1?o[0]:Je(o)}const Pt=Object.freeze(Object.defineProperty({__proto__:null,createBlob:Bt,decode:Ge,decodeAudioData:_t,encode:Ve,generateTTSWithChunking:Ie,mergeWavBlobs:Je,pcmToWav:Ye,splitTextIntoSafeChunks:Ke},Symbol.toStringTag,{value:"Module"}));var Ot=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,ue=(t,e,s,n)=>{for(var o=n>1?void 0:n?Ht(e,s):e,a=t.length-1,i;a>=0;a--)(i=t[a])&&(o=(n?i(e,s,o):i(o))||o);return n&&o&&Ot(e,s,o),o};let se=class extends _{constructor(){super(...arguments),this.lessons=[],this.generatingLessons=new Map}selectLesson(t){this.dispatchEvent(new CustomEvent("lesson-selected",{detail:t,bubbles:!0,composed:!0}))}render(){return c`
      <ul class="lesson-list">
        ${this.lessons.map(t=>{var n,o;const e=(n=this.generatingLessons)==null?void 0:n.has(t.id),s=(o=this.generatingLessons)==null?void 0:o.get(t.id);return c`
    ...
    `}createRenderRoot(){return this}};ue([E({type:Array})],se.prototype,"lessons",2);ue([E({type:Number})],se.prototype,"selectedLessonId",2);ue([E({type:Object})],se.prototype,"generatingLessons",2);se=ue([ae("lesson-selector")],se);var Wt=Object.defineProperty,Et=Object.getOwnPropertyDescriptor,pe=(t,e,s,n)=>{for(var o=n>1?void 0:n?Et(e,s):e,a=t.length-1,i;a>=0;a--)(i=t[a])&&(o=(n?i(e,s,o):i(o))||o);return n&&o&&Wt(e,s,o),o};let ne=class extends _{constructor(){super(...arguments),this.lesson=null,this.isSyncingLeft=!1,this.isSyncingRight=!1}updated(t){t.has("lesson")&&(this.englishContainer&&(this.englishContainer.scrollTop=0),this.arabicContainer&&(this.arabicContainer.scrollTop=0)),super.updated(t)}handleScroll(t){const e=this.englishContainer,s=this.arabicContainer;if(!(!e||!s))if(t==="english"){if(this.isSyncingLeft){this.isSyncingLeft=!1;return}this.isSyncingRight=!0;const n=e.scrollTop/(e.scrollHeight-e.clientHeight);s.scrollTop=n*(s.scrollHeight-s.clientHeight)}else{if(this.isSyncingRight){this.isSyncingRight=!1;return}this.isSyncingLeft=!0;const n=s.scrollTop/(s.scrollHeight-s.clientHeight);e.scrollTop=n*(e.scrollHeight-e.clientHeight)}}render(){if(!this.lesson)return c``;const s=(this.lesson.text||"").replace(/\n\s*\n/g,`
...
`).filter(i=>i.trim().length>0);return c`
        ...
        <form @submit=${this.handleSubmit} novalidate style="display: flex; flex-direction: column; gap: 1.75rem;">
          ...
          <div class="form-group" style="display: flex; flex-direction: column; gap: 0.5rem; text-align: right;">
            <label for="audio-input" style="font-weight: 700; font-size: 0.95rem; color: #ffffff; display: flex; align-items: justify; justify-content: flex-start; flex-wrap: wrap; gap: 0.4rem;">
              ...
              ${t?c`<span style="font-size: 0.75rem; color: #94a3b8; font-weight: 500;">(اختياري: اتركه فارغاً للاحتفاظ بملف الصوت الحالي)</span>`:""}
            </label>
...
`+this.lessons.map((w,I)=>`- الدرس #${I+1}: [${w.title}] يحتوي على: "${w.text?w.text.slice(0,100)+"...":""}"`).join(`
...
- حافظ على النبرة الإيجابية، المحفزة والمشجعة دائماً ومساعدة الطلاب على التعلم الفعال والممتع.`;let p=this.messages.slice(-20).map(w=>({role:w.role,parts:[{text:w.text}]}));for(;p.length>0&&p[0].role!=="user";)p.shift();p.length===0&&t&&(p=[{role:"user",parts:[{text:t}]}]);const g=[];for(const w of p)if(g.length===0)w.role==="user"&&g.push(w);else{const I=g[g.length-1];I.role===w.role?I.parts[0].text+=`

`+w.parts[0].text:g.push(w)}const b=localStorage.getItem("lingo_custom_api_key"),x=b&&b.trim()!==""&&b!=="undefined"&&b!=="null"?b.trim().replace(/^["']|["']$/g,""):null,z={"Content-Type":"application/json"};x&&(z["x-gemini-api-key"]=x);let v=null,T="",B=!1;try{v=await fetch("/api/gemini",{method:"POST",headers:z,body:JSON.stringify({contents:g,systemInstruction:h,temperature:.7})}),!v.ok&&x&&(console.warn("Backend API returned error, attempting direct Gemini API..."),B=!0,v=null)}catch(w){if(console.warn("Backend API connection failed, attempting direct Gemini API:",w),x)B=!0;else throw new Error("فشل الاتصال بالخادم. يرجى إدخال مفتاح API الخاص بك في الإعدادات المتقدمة لتفعيل الاتصال المباشر.")}if(B&&x){const w=["gemini-2.5-flash","gemini-2.0-flash","gemini-1.5-flash"];let I=null,me=!1;for(const U of w)try{console.log(`[Direct Gemini Chat] Requesting model: ${U}`);const P=`https://generativelanguage.googleapis.com/v1beta/models/${U}:generateContent?key=${x}`,ie=await fetch(P,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:g,systemInstruction:{parts:[{text:h}]},generationConfig:{temperature:.7}})});if(!ie.ok){const ge=await ie.json().catch(()=>({}));throw new Error(((s=ge==null?void 0:ge.error)==null?void 0:s.message)||`HTTP status ${ie.status}`)}const Ae=(r=(i=(a=(o=(n=(await ie.json()).candidates)==null?void 0:n[0])==null?void 0:o.content)==null?void 0:a.parts)==null?void 0:i[0])==null?void 0:r.text;if(Ae){T=Ae,me=!0,console.log(`[Direct Gemini Chat] Success with model: ${U}`);break}}catch(P){console.warn(`[Direct Gemini Chat] Model ${U} failed:`,P),I=P}if(!me)throw I||new Error("فشلت جميع محاولات الاتصال المباشر بذكاء Gemini مع مفتاح الـ API الخاص بك.")}else if(v){if(!v.ok){const I=await v.json().catch(()=>({}));throw new Error(I.error||"فشل الاتصال بخدمة المساعد الدراسي الذكي.")}T=(await v.json()).text||"عذراً، لم أتمكن من صياغة إجابة مناسبة حالياً."}else throw new Error("لم يتم الحصول على استجابة من الخادم أو الـ API المباشر.");const V={role:"model",text:T,timestamp:Date.now()};this.messages=[...this.messages,V],this.saveHistory()}catch(l){console.error("Gemini Chat error:",l),this.errorMessage=(l==null?void 0:l.message)||"واجهت مشكلة غير متوقعة أثناء الاتصال بـ Gemini."}finally{this.isGenerating=!1,this.scrollToBottom()}}handleChipClick(t){const e=this.querySelector("#chat-input");e&&(this.inputValue=t,e.value=t,e.focus())}formatText(t){if(!t)return"";let e=t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return e=e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*(.*?)\*/g,"<em>$1</em>"),e=e.split(`
...
`)}`);return}this.generatingLessons.set(-t,{progress:75,timeRemaining:1}),this.generatingLessons=new Map(this.generatingLessons);const{mergeWavBlobs:r}=await Xe(async()=>{const{mergeWavBlobs:d}=await Promise.resolve().then(()=>Pt);return{mergeWavBlobs:d}},void 0),l=await r(a);await G(-t,l),this.readyReferenceAudios.add(t),this.readyReferenceAudios=new Set(this.readyReferenceAudios);const h=URL.createObjectURL(l);((o=this.selectedLesson)==null?void 0:o.id)===-t&&(this.selectedLesson=this.getReferenceLessonForGroup(t),this.audioSrc=h),this.stopLessonProgressCountdown(-t),this.generatingLessons.delete(-t),this.generatingLessons=new Map(this.generatingLessons)}catch(a){console.error("Error merging reference audio:",a),this.stopLessonProgressCountdown(-t),this.generatingLessons.delete(-t),this.generatingLessons=new Map(this.generatingLessons),alert(`فشل دمج الملف الصوتي المرجعي: ${(a==null?void 0:a.message)||a}`)}}renderPrecedingLessonsStatus(t){const e=(t-1)*10,s=t*10-1,n=this.lessons.slice(e,s+1);return c`
      <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(110px, 1fr)); gap: 0.5rem; margin-top: 0.5rem; background: rgba(0,0,0,0.2); padding: 0.75rem; border-radius: 8px; border: 1px solid rgba(255,255,255,0.04);">
        ${n.map((o,a)=>{const i=!!o.audioSrc;return c`
...
<body>
    ...
    `}renderPlayer(){const t=$`<svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"></path></svg>`,e=$`<svg viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"></path></svg>`,s=$`<svg viewBox="0 0 24 24" style="position: relative;"><path d="M11 18V6l-8.5 6 8.5 6zm-2-6 6 4.5V7.5l-6 4.5z"></path></svg>`,n=$`<svg viewBox="0 0 24 24" style="position: relative;"><path d="M13 6v12l8.5-6-8.5-6zM4 18l8.5-6L4 6v12z"></path></svg>`,o=$`<svg viewBox="0 0 24 24"><path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"></path></svg>`,a=$`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:20px; height:20px;"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>`;return c`
    ...
    `}renderDashboard(){const t=$`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>`,e=this.lessons.length,s=this.lessons.filter(o=>o.audioSrc).length,n=this.lessons.reduce((o,a)=>o+(a.text?a.text.split(/\s+/).filter(Boolean).length:0),0);return c`
      <div class="dashboard-container" dir="rtl">
        ...
        <div class="lessons-grid" style="margin-top: 1rem;">
          ${this.lessons.map((o,a)=>{const i=!!o.audioSrc,r=a>0&&a%10===0?c`
            ...
            `:"",l=(a+1)%10===0,h=(a+1)/10,d=l?this.getReferenceLessonForGroup(h):null,u=l?this.readyReferenceAudios.has(h):!1,p=d?c`
              <div class="lesson-card reference-card" @click=${()=>{this.selectedLesson=d,this.currentView="detail"}}>
                <div class="lesson-card-right">
                  <div class="lesson-meta">
                    <span class="lesson-num ref-badge">🎯 مرجع مجمع</span>
                  </div>
                  <div class="lesson-details">
                    <h3 class="lesson-card-title ref-title">${d.title}</h3>
                ...
                <div class="lesson-card-left">
                  ${u?c`<span class="audio-badge ref-audio-ready">🔊 مدمج ومكتمل</span>`:c`<span class="audio-badge secondary">✨ جاهز للدمج</span>`}
            ...
            `:"";return c`
              ...
              <div class="lesson-card" @click=${()=>{this.selectedLesson=o,this.currentView="detail"}}>
                ...
                <div class="lesson-card-left">
                  ${i?c`<span class="audio-badge">🔊 صوت جاهز</span>`:c`<span class="audio-badge secondary">🧠 جاهز للتوليد</span>`}
    ...
    `}renderDetailView(){var n,o;$`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.9959.9959 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>`;const t=$`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2 6.4 4.5 5 7zM19.5 15.4L22 14l-1.4-2.5L22 9l-2.5 1.4L17 9l1.4 2.5L17 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-8.8 9L11 6.5 8.8 11 4.3 13.2l4.5 2.2L11 19.9l2.2-4.5 4.5-2.2z"/></svg>`,e=this.selectedLesson?this.generatingLessons.has(this.selectedLesson.id):!1,s=this.selectedLesson?this.generatingLessons.get(this.selectedLesson.id):null;return c`
        ...
        ${this.selectedLesson?c`
          ...
          <div class="compact-audio-box">
            ...
            `:this.audioSrc?c`
              ...
              ></audio>
              ${this.renderPlayer()}
            `:(o=this.selectedLesson)!=null&&o.isReference?c`
    ...
    `}renderAddView(){return c`
      ...
      ></add-lesson-view>
    `}render(){let t;return this.currentView==="list"?t=this.renderDashboard():this.currentView==="add"?t=c`
    ...
    `}renderPlatformSettingsModal(){return this.isPlatformSettingsOpen?c`
    ...
    `:""}createRenderRoot(){return this}};y([m()],f.prototype,"lessons",2);y([m()],f.prototype,"selectedLesson",2);y([m()],f.prototype,"currentView",2);y([m()],f.prototype,"lessonToEdit",2);y([m()],f.prototype,"audioSrc",2);y([m()],f.prototype,"isPlaying",2);y([m()],f.prototype,"currentTime",2);y([m()],f.prototype,"duration",2);y([m()],f.prototype,"playbackRate",2);y([m()],f.prototype,"seekStep",2);y([m()],f.prototype,"isSettingsOpen",2);y([m()],f.prototype,"isLoadingAudio",2);y([m()],f.prototype,"generatingLessons",2);y([m()],f.prototype,"readyReferenceAudios",2);y([m()],f.prototype,"isChatOpen",2);y([m()],f.prototype,"customApiKey",2);y([m()],f.prototype,"isPlatformSettingsOpen",2);y([m()],f.prototype,"backupStatus",2);y([C("#audio-player")],f.prototype,"audioPlayer",2);y([C("#scroll-container")],f.prototype,"scrollContainer",2);y([C(".settings-container")],f.prototype,"settingsContainer",2);f=y([ae("english-learning-app")],f);/**
